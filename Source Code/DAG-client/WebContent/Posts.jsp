...
<div class="container">
		<div class="col-lg-12">
			...
			<a href="PostItem.jsp"><button id="add_item" class = "btn btn-default">Post an item</button></a>
	</div>
	...
	<%
	 ...
	 %> 
		...
		<%--  		td.innerHTML="<a href="PdelControllerServlet?pid=<%=p[i].id %>"><button class = 'btn btn-default' onClick='$(this).closest('tr').remove();'>Delete Item</button></a>"
		 --%> 		
		        td.innerHTML="<a href='PbidsControllerServlet?pid=<%=p[i].id %>' class = 'btn btn-default' >Select Item</a>"
...
<%--  		td.innerHTML="<a href="PdelControllerServlet?pid=<%=p[i].id %>"><button class = 'btn btn-default' onClick='$(this).closest('tr').remove();'>Delete Item</button></a>"
 --%> 		
        td.innerHTML="<a href='PdelControllerServlet?pid=<%=p[i].id %>' class = 'btn btn-default' >Delete Item</a>"
		td.style.borderColor="#ffffff";
        td.style.backgroundColor="#ffffff";
<%}%> 
