...
/**
 * Servlet implementation class PdelControllerServlet
 */
@WebServlet("/PdelControllerServlet")
public class PdelControllerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PdelControllerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else
			{
				...
				WebResource webResource = client.resource(urlString + "product/deleteProduct/"+id+"/"+auth+"/"+pid);
